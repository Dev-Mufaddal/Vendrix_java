		...
		try {
			...
			while (rs.next()) {
				...
				if (item.quantity > item.stock) {
					throw new Exception("Insufficient stock for " + item.productName + ". Available: " + item.stock);
				}
			...
			out.println("{\"success\":true,\"orderId\":" + orderId + ",\"message\":\"Payment verified and order #"
