			...
			<div class="col-md-3 col-lg-2 p-0">
				<div class="sidebar">
					...
					<a href="dashboard.jsp"><i class="bi bi-speedometer2"></i>
						...
						href="view-products.jsp"><i class="bi bi-list-ul"></i> View
						Products</a> <a href="../logout.jsp"><i
				...
				<nav class="navbar navbar-light bg-light mb-4">
					<div class="container-fluid">
						...
						<div>
							...
							</span> <a href="view-products.jsp" class="btn btn-secondary btn-sm">
					...
					<div class="card-body">
						<form action="UpdateProductServlet" method="post" class="row g-3">
							...
							<div class="col-md-8">
								...
								<div class="mb-3">
									<label class="form-label">Update Image URL (Optional)</label> <input
										type="text" name="image" class="form-control"
										value="<%=currentImage != null ? currentImage : ""%>"
										placeholder="Enter new image URL or leave current"> <small
										class="text-muted">Leave empty to keep current image</small>
								</div>
									...
									<div class="card-body">
										...
										<ul class="list-group list-group-flush">
											<li class="list-group-item d-flex justify-content-between">
												<span>Product ID:</span> <strong><%=rs.getInt("id")%></strong>
											</li>
											<li class="list-group-item d-flex justify-content-between">
												<span>Created:</span> <span><%=rs.getTimestamp("created_at")%></span>
											</li>
											<li class="list-group-item d-flex justify-content-between">
												<span>Last Updated:</span> <span><%=rs.getTimestamp("created_at")%></span>
											</li>
										</ul>
									</div>
								</div>
							...
							<div class="col-12">
								<div class="d-flex gap-2">
									...
									<a href="view-products.jsp" class="btn btn-secondary"> <i
