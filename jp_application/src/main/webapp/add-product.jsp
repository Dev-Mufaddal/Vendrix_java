			...
			<div class="col-md-3 col-lg-2 p-0">
				<div class="sidebar">
					...
					<a href="dashboard.jsp"><i class="bi bi-speedometer2"></i>
						Dashboard</a> <a href="add-product.jsp" style="background: #495057;"><i
						class="bi bi-plus-circle"></i> Add Product</a> <a
						href="view-products.jsp"><i class="bi bi-list-ul"></i> View
						Products</a> <a href="logout.jsp"><i class="bi bi-box-arrow-left"></i>
						Logout</a>
				</div>
			</div>
			...
			<div class="col-md-9 col-lg-10 p-4">
				<nav class="navbar navbar-light bg-light mb-4">
					<div class="container-fluid">
						...
						<span class="navbar-text"> Welcome, <%=session.getAttribute("user_fname")%>
						</span>
					</div>
				</nav>
				...
				<form action="AddProductServlet" method="post" class="mt-4">
						...
						<div class="col-md-6">
							<div class="mb-3">
								<label class="form-label">Stock Quantity</label> <input
									type="number" name="stock" class="form-control" value="0">
							</div>

							<div class="mb-3">
								<label class="form-label">Image URL (Optional)</label> <input
									type="text" name="image" class="form-control"
									placeholder="https://example.com/image.jpg"> <small
									class="text-muted">Leave empty for default image</small>
							</div>
						</div>
					</div>
					...
					<div class="d-flex gap-2">
						...
						<a href="dashboard.jsp" class="btn btn-secondary"> <i
