...
<head>
<meta charset="UTF-8">
<title><%=productName.isEmpty() ? "Product Details" : productName%>
	- Ecommerce</title>
...
<body>
	...
	<div class="container mt-4">
		...
		<div class="alert alert-danger">
			...
			<p>The product you're looking for doesn't exist or has been
				removed.</p>
		...
		<nav aria-label="breadcrumb" class="mb-4">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a
					href="products.jsp?category=<%=java.net.URLEncoder.encode(category, "UTF-8")%>"><%=category%></a></li>
				<%
				}
				%>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="mb-3">
					<img id="mainImage" src="<%=imagePath%>" alt="<%=productName%>"
						class="product-image"
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="mb-3">
							...
							if (!outOfStock) {
							%>
							<span class="text-success ms-3"> <i
								class="bi bi-check-circle"></i> <%=stock%> available
							</span>
							<%
							} else {
							%>
							<span class="text-danger ms-3"> <i class="bi bi-x-circle"></i>
								Out of Stock
							</span>
							<%
							}
 ...
 %>
						...
						<div class="card bg-light">
							<div class="card-body">
								...
								<div class="row align-items-center">
									...
									<div class="col-md-8">
										<button id="addToCartBtn" class="btn btn-success w-100"
											onclick="addToCart()">
								...
								<div class="text-center">
									...
									<p class="text-muted mt-2">Get notified when this product
										is back in stock</p>
						...
						<div class="mt-3 d-flex gap-2">
							...
							%>
							<a href="admin/edit-product.jsp?id=<%=productId%>"
								class="btn btn-outline-warning ms-auto"> <i
		...
		<div class="mt-5">
			...
			<div class="row">
				...
				if (category != null && !category.isEmpty()) {
					...
					try {
						conn2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/ecom", "root", "");
				...
				<div class="col-md-3 col-sm-6 mb-3">
					<div class="card h-100">
						<img src="<%=relatedImagePath%>" class="card-img-top"
							alt="<%=relatedName%>"
							style="height: 150px; object-fit: cover;">
						<div class="card-body">
							<h6 class="card-title"><%=relatedName%></h6>
							<p class="card-text text-success fw-bold">
								$<%=String.format("%.2f", relatedPrice)%></p>
							<a href="product-details.jsp?id=<%=relatedId%>"
