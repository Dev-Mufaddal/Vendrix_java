...
<body>
		...
		<div class="row">
			...
			<div class="col-md-3 col-lg-2 p-0">
				<div class="sidebar">
					...
					<a href="dashboard.jsp" style="background: #495057;"> <i
						class="bi bi-speedometer2"></i> Dashboard
					</a> <a href="add-product.jsp"> <i class="bi bi-plus-circle"></i>
						Add Product
					</a> <a href="view-products.jsp"> <i class="bi bi-list-ul"></i>
						View Products
					</a> <a href="users.jsp"> <i class="bi bi-people"></i> Users
					</a> <a href="orders.jsp"> <i class="bi bi-cart"></i> Orders
					</a> <a href="logout.jsp"> <i class="bi bi-box-arrow-left"></i>
						Logout
					</a>
				</div>
			</div>
			...
			<div class="col-md-9 col-lg-10 p-0">
				<nav class="navbar navbar-light bg-light p-3 border-bottom">
					<div class="container-fluid">
						...
						<div class="d-flex align-items-center">
							...
							</span> <span class="badge bg-danger"> <i
								class="bi bi-shield-check"></i> Admin
							</span>
						</div>
					</div>
				</nav>
				...
				<div class="p-4">
					...
					<div class="alert alert-info">
						...
						<p class="mb-0">
							Manage your e-commerce store efficiently. Last login:
								...
								<div class="card-body">
									...
									<div class="mt-3">
										<a href="view-products.jsp"
											...
											class="bi bi-arrow-right-circle"></i> View All Products
										</a>
									</div>
								</div>
							</div>
						...
						<div class="col-md-3 mb-3">
							<div class="card stat-card text-white bg-warning">
								<div class="card-body">
									...
									<div class="mt-3">
										<a href="view-products.jsp?filter=lowstock"
											class="text-white text-decoration-none"> <i
											class="bi bi-arrow-right-circle"></i> Check Stock
										</a>
									</div>
								</div>
							</div>
						...
						<div class="col-md-8">
							<div class="card">
								<div
									...
									<a href="add-product.jsp" class="btn btn-primary btn-sm"> <i
 ...
 %>
													...
													<td class="<%=stockClass%>"><%=rs.getInt("stock_quantity")%>
													</td>
													<td><small> <%=rs.getTimestamp("created_at").toString().substring(0, 10)%>
													</small></td>
													<td><a
														href="edit-product.jsp?id=<%=rs.getInt("id")%>"
												...
												<tr>
													<td colspan="6" class="text-center text-muted"><i
														class="bi bi-info-circle"></i> No products found</td>
												</tr>
												<%
												} finally {
												try {
								...
								<div class="card-footer text-center">
									<a href="view-products.jsp" class="btn btn-link"> <i
										class="bi bi-arrow-right"></i> View All Products
									</a>
								</div>
							</div>
						</div>
									...
									<div class="list-group">
										<a href="add-product.jsp"
											...
											<div>
												...
												<small class="text-muted">Add a new product to your
													store</small>
											</div>
										</a> <a href="view-products.jsp"
											class="list-group-item list-group-item-action d-flex align-items-center">
											<i class="bi bi-list-check fs-5 text-success me-3"></i>
											<div>
												<h6 class="mb-1">Manage Products</h6>
												<small class="text-muted">Edit, delete or view all
													products</small>
											</div>
										</a>
										<%
										...
										%>
										<a href="view-products.jsp?filter=lowstock"
											class="list-group-item list-group-item-action d-flex align-items-center bg-warning bg-opacity-10">
											<i class="bi bi-exclamation-triangle fs-5 text-warning me-3"></i>
											<div>
												<h6 class="mb-1">Low Stock Alert</h6>
												<small class="text-muted"><%=lowStockCount%>
													products need restocking</small>
											</div>
										</a>
										<%
										}
								...
								<div class="card-body">
									<ul class="list-group list-group-flush">
										<li class="list-group-item d-flex justify-content-between">
											<span>Server Time:</span> <span><%=new java.util.Date()%></span>
										</li>
										<li class="list-group-item d-flex justify-content-between">
											<span>Database:</span> <span>MySQL</span>
										</li>
										<li class="list-group-item d-flex justify-content-between">
											<span>Products:</span> <span
											class="badge bg-primary rounded-pill"><%=productCount%></span>
										</li>
										<li class="list-group-item d-flex justify-content-between">
											<span>Users:</span> <span
											class="badge bg-success rounded-pill"><%=userCount%></span>
										</li>
									</ul>
								</div>
							</div>
