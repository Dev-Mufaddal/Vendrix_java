	...
	<div class="container mt-4">
		...
		<nav aria-label="breadcrumb" class="mb-4">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="order-history.jsp">Order
						History</a></li>
		...
		try {
			...
			// Get order details
			String sql = "SELECT o.*, a.address, a.city, a.state, a.zip_code, " + "u.first_name, u.last_name "
			+ "FROM orders o " + "LEFT JOIN addresses a ON o.address_id = a.id "
			+ "LEFT JOIN users u ON o.user_id = u.id " + "WHERE o.id = ? AND o.user_id = ?";
				...
				<div class="row align-items-center">
					<div class="col-md-8">
						...
						<p class="text-white-50 mb-2">
							...
							<%=customerName%>
							• <i class="bi bi-calendar"></i> Estimated Delivery:
							<%=estimatedDelivery%>
						</p>
					...
					<div class="col-md-4 text-end">
						<h2 class="text-white mb-0">
							₹<%=String.format("%.2f", orderTotal)%></h2>
						<span class="badge bg-light text-dark fs-6"> <%=orderStatus.substring(0, 1).toUpperCase() + orderStatus.substring(1)%>
						</span>
					</div>
				</div>
			</div>
		...
		<div class="card mb-4">
			<div class="card-header bg-light">
				<h5 class="mb-0">
					<i class="bi bi-truck"></i> Order Tracking Timeline
				</h5>
			</div>
			<div class="card-body">
				<div class="timeline">
					...
					<div class="timeline-item completed">
						...
						<div class="timeline-content">
							<h6>Order Placed</h6>
							<p class="text-muted small mb-2">Your order has been
								confirmed</p>
					...
					<div
						class="timeline-item <%=orderStatus.equals("pending")
		? "current"
		: orderStatus.equals("confirmed") || orderStatus.equals("processing") || orderStatus.equals("shipped")
				|| orderStatus.equals("delivered") ? "completed" : "pending"%>">
						...
						<div class="timeline-content">
							...
							<p class="text-muted small mb-2">Seller has processed your
								order</p>
							<%
							...
							<%
							} else if (orderStatus.equals("confirmed") || orderStatus.equals("processing") || orderStatus.equals("shipped")
					...
					<!-- Step 3: Processing -->
					<div
						class="timeline-item <%=orderStatus.equals("confirmed")
		? "current"
		: orderStatus.equals("processing") || orderStatus.equals("shipped") || orderStatus.equals("delivered")
				? "completed"
				: "pending"%>">
						<div class="timeline-icon">
						...
						<div class="timeline-content">
							...
							<span class="badge bg-primary">Current</span>
							<%
							} else if (orderStatus.equals("processing") || orderStatus.equals("shipped") || orderStatus.equals("delivered")) {
							%>
							<span class="badge bg-success">Completed</span>
							<%
							} else {
					...
					<!-- Step 4: Shipped -->
					<div
						class="timeline-item <%=orderStatus.equals("shipped") ? "current" : orderStatus.equals("delivered") ? "completed" : "pending"%>">
						<div class="timeline-icon">
					...
					<!-- Step 5: Delivered -->
					<div
						class="timeline-item <%=orderStatus.equals("delivered") ? "current" : "pending"%>">
						<div class="timeline-icon">
			...
			<div class="col-md-6">
				<div class="card h-100">
					...
					<div class="card-body">
						...
						<div class="d-flex align-items-center">
							<img src="https://via.placeholder.com/40" alt="Shipping Partner"
								class="rounded me-3">
							<div>
				...
				<div class="card h-100">
					...
					<div class="card-body">
						<div class="d-flex justify-content-between mb-2">
							<span>Order Status:</span> <strong><%=orderStatus.substring(0, 1).toUpperCase() + orderStatus.substring(1)%></strong>
						</div>
						<div class="d-flex justify-content-between mb-2">
							<span>Payment Status:</span> <strong class="text-success">Paid</strong>
						</div>
						<div class="d-flex justify-content-between mb-2">
							<span>Payment Method:</span> <strong>Online Payment</strong>
						</div>
						<div class="d-flex justify-content-between mb-2">
							<span>Order Date:</span> <strong><%=estimatedDelivery%></strong>
						</div>
						<div class="d-flex justify-content-between mb-2">
							<span>Tracking Number:</span> <strong><%=trackingNumber%></strong>
						</div>

						<hr>

						<h6>Need Help?</h6>
						<p class="text-muted small mb-3">Contact us for any
							order-related queries</p>
		...
		<div class="mt-4 text-center">
			...
			<a href="order-history.jsp" class="btn btn-outline-secondary"> <i
				class="bi bi-arrow-left"></i> Back to Orders
			</a>
		</div>
	</div>
