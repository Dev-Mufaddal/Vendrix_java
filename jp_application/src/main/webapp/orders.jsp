			...
			<div class="col-12">
				...
				<div class="d-flex justify-content-between align-items-center mb-4">
					<div>
						...
						<p class="text-muted mb-0">View your order history and track
							shipments</p>
					</div>
					<div>
				...
				try {
					...
					String orderSql = "SELECT o.*, COUNT(oi.id) as item_count " + "FROM orders o "
					+ "LEFT JOIN order_items oi ON o.id = oi.order_id " + "WHERE o.user_id = ? " + "GROUP BY o.id "
						...
						<div class="row align-items-center">
							...
							<div class="col-md-8">
								...
								<div class="d-flex align-items-center">
									...
									%>
									<span class="badge bg-success ms-3"> <i
										class="bi bi-check-circle"></i> Paid
									</span>
									<%
									} else if ("pending".equalsIgnoreCase(paymentStatus)) {
									%>
									<span class="badge bg-warning ms-3"> <i
										class="bi bi-clock"></i> Payment Pending
									</span>
									<%
									} else if (paymentStatus != null) {
									%>
									<span class="badge bg-secondary ms-3"> <%=paymentStatus%>
									</span>
									<%
									}
									%>
				...
				<div class="empty-orders">
					<div class="card border-0 shadow-sm">
						<div class="card-body py-5">
							...
							<p class="text-muted mb-4">You haven't placed any orders yet.
							...
							<div class="d-grid gap-2 col-md-6 mx-auto">
								...
								</a> <a href="index.jsp" class="btn btn-outline-secondary"> <i
				...
				<div class="alert alert-danger">
					<div class="d-flex align-items-center">
						...
						<div>
							...
							<p class="mb-0">An error occurred while loading your orders.
