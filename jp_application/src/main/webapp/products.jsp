...
<body>
	...
	<div class="container" style="margin-top: 65px">
		...
		<div class="row mb-4">
			<div class="col-md-8">
				<h1>
					<i class="bi bi-shop"></i> Our Products
				</h1>
				<p class="text-muted">Browse our wide collection of quality
					products</p>
			</div>
			<div class="col-md-4">
				<!-- Search and Filter -->
		...
		<div class="row mb-4">
			<div class="col-12">
				<div class="btn-group" role="group">
					...
					%>
					<a
						href="products.jsp?category=<%=java.net.URLEncoder.encode(category, "UTF-8")%>"
		...
		<div class="row">
					...
					<div class="card-body d-flex flex-column">
						...
						<div
							...
							<div class="stock">
								...
								<small class="text-muted"> <i
									class="bi bi-check-circle text-success"></i> <%=stock%> in
									stock
								</small>
								<%
								}
						...
						<div class="d-grid gap-2 mt-3">
							<a href="product-details.jsp?id=<%=productId%>"
								class="btn btn-primary"> <i class="bi bi-eye"></i> View
								Details
							</a>
							<%
							if (!outOfStock) {
			...
			<div class="col-12 text-center py-5">
				...
				<p class="text-muted">Try different search terms or check back
					later</p>
			...
			%>
			<div class="col-12">
				<div class="alert alert-danger">Error loading products. Please
					try again later.</div>
			</div>
			<%
			} finally {
