...
<body>
			...
			<div class="col-md-3 col-lg-2 p-0">
				<div class="sidebar">
					...
					<a href="dashboard.jsp"><i class="bi bi-speedometer2"></i>
						Dashboard</a> <a href="add-product.jsp"><i
						class="bi bi-plus-circle"></i> Add Product</a> <a
						href="view-products.jsp" style="background: #495057;"><i
						class="bi bi-list-ul"></i> View Products</a> <a href="logout.jsp"><i
			...
			<div class="col-md-9 col-lg-10 p-4">
				<nav class="navbar navbar-light bg-light mb-4">
					<div class="container-fluid">
						...
						<div>
							<span class="navbar-text me-3"> Welcome, <%=session.getAttribute("user_fname")%>
							</span> <a href="add-product.jsp" class="btn btn-primary btn-sm"> <i
								...
								<tbody>
									...
									<tr>
										...
										<td><img src="<%=imagePath%>"
											alt="<%=rs.getString("name")%>" class="product-img"
 ...
 %>
										...
										<td><span
											class="badge <%=rs.getInt("stock_quantity") > 0 ? "bg-success" : "bg-danger"%>">
										...
										<td>
											<div class="btn-group btn-group-sm" role="group">
												...
												</a> <a href="DeleteProductServlet?id=<%=rs.getInt("id")%>"
													class="btn btn-danger"
													onclick="return confirm('Are you sure you want to delete <%=rs.getString("name")%>?')"
													title="Delete"> <i class="bi bi-trash"></i>
												</a> <a href="#" class="btn btn-info" title="View Details"
													data-bs-toggle="modal"
													data-bs-target="#productModal<%=rs.getInt("id")%>"> <i
													class="bi bi-eye"></i>
												</a>
											</div> <!-- Product Details Modal -->
											<div class="modal fade" id="productModal<%=rs.getInt("id")%>"
												tabindex="-1">
													...
													<div class="modal-content">
														...
														<div class="modal-body">
															...
															<table class="table table-sm">
																...
																<tr>
																	<th>Category:</th>
																	<td><%=category != null ? category : "None"%></td>
																</tr>
																<tr>
																	<th>Stock:</th>
																...
																<tr>
																	<th>Description:</th>
																	<td><%=desc != null ? desc : "No description"%></td>
																</tr>
																<tr>
																	<th>Added:</th>
						...
						<div class="text-center py-5">
							...
							<a href="add-product.jsp" class="btn btn-primary"> <i
								class="bi bi-plus-circle"></i> Add First Product
							</a>
						</div>
						<%
						}
