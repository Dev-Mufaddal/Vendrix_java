<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="jakarta.servlet.http.*, java.sql.*, java.util.*"%>
...
try {
	...
	String cartSql = "SELECT c.quantity, p.price, p.name " + "FROM cart c " + "JOIN products p ON c.product_id = p.id "
	+ "WHERE c.user_id = ?";
...
<body>
	...
	<div class="container mt-4 checkout-container">
		...
		<div class="payment-steps">
			<h5>
				<i class="bi bi-list-check"></i> How to Pay:
			</h5>
			<div class="payment-step">
				<div class="step-number">1</div>
				<div>
					<strong>Click "Pay with Razorpay"</strong>
					<p class="mb-0 text-muted">Enter your billing details and
						proceed</p>
				</div>
			</div>
			<div class="payment-step">
				...
				<div>
					...
					<p class="mb-0 text-muted">Select Credit/Debit Card, UPI,
						NetBanking or Wallet</p>
				</div>
			</div>
			<div class="payment-step">
			...
			<div class="payment-step">
				...
				<div>
					...
					<p class="mb-0 text-muted">You'll be redirected to order
						confirmation page</p>
				</div>
			</div>
		</div>
			...
			<div class="row align-items-center">
				<div class="col-md-6">
					...
					<p class="text-muted">
						...
						<i class="bi bi-check-circle text-success"></i> Trusted by 5M+
						businesses
					</p>
				</div>
				<div class="col-md-6">
					<div class="card">
						...
						<div class="card-body">
							<div class="d-flex justify-content-between mb-2">
								<span>Subtotal (<%=cartItemCount%> items)
								</span> <span>₹<%=String.format("%.2f", subtotal)%></span>
							</div>
							<div class="d-flex justify-content-between mb-2">
								<span>Shipping</span> <span><%=shipping == 0 ? "FREE" : "₹" + String.format("%.2f", shipping)%></span>
							</div>
							<div class="d-flex justify-content-between mb-2">
								<span>Tax (10%)</span> <span>₹<%=String.format("%.2f", tax)%></span>
							</div>
							<hr>
							<div class="d-flex justify-content-between fw-bold fs-5">
								<span>Total Amount</span> <span>₹<%=String.format("%.2f", total)%></span>
							</div>
		...
		<div class="mb-4">
			<h5>
				<i class="bi bi-credit-card-2-front"></i> Select Payment Option
			</h5>
			<div class="payment-options">
				<div class="payment-option selected"
					onclick="selectPayment('online')" id="onlineOption">
					<div class="payment-icon">
						<i class="bi bi-credit-card"></i>
					</div>
					<h6>Online Payment</h6>
					<small class="text-muted">Credit/Debit Card, UPI,
						NetBanking</small>
				</div>
		...
		<div class="form-check mb-4">
			<input class="form-check-input" type="checkbox" id="agreeTerms"
				...
				data-bs-target="#termsModal">Terms and Conditions</a> and authorize
				the payment
			</label>
		</div>
		...
		<div class="d-grid gap-2">
			<button type="button" class="btn btn-primary btn-lg"
				onclick="initiatePayment()" id="payButton">
		...
		<div class="alert alert-light border mt-4">
			<div class="d-flex align-items-center">
				...
				<div>
					...
					<p class="mb-0 small text-muted">All transactions are secured
						with 256-bit SSL encryption. Your card details are never stored on
						our servers.</p>
				</div>
			</div>
		</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<p>
						<strong>Note:</strong> You will be redirected to Razorpay's secure
...
async function initiatePayment() {
    ...
    try {
        ...
        const options = {
            key: orderData.razorpayKey || 'rzp_test_S5iOpvQklhHykr', // You'll set this in servlet
