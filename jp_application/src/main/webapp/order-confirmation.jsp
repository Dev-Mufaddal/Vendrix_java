...
<body>
	...
	<div class="container mt-4 confirmation-container">
		...
		try {
			...
			// Get order items
			String itemsSql = "SELECT oi.*, p.name, p.image FROM order_items oi " + "JOIN products p ON oi.product_id = p.id "
			+ "WHERE oi.order_id = ?";
		...
		<div class="text-center mb-5">
			...
			<p class="lead">Thank you for your purchase. Your order has been
				received.</p>
			<div class="alert alert-success d-inline-block">
				<i class="bi bi-info-circle"></i> Order ID: <strong>#<%=orderId%></strong>
				...
				<div class="card mt-3">
					<div class="card-body text-center">
						...
						<a href="mailto:support@ecommerce.com"
							...
							class="bi bi-envelope"></i> Email Support
						</a>
					</div>
				</div>
			</div>
								...
								<table class="table table-sm">
									...
									<tr>
										...
										<td>
											...
											%> <i
											class="bi bi-credit-card"></i> Credit/Debit Card <%
 } else if ("paypal".equals(paymentMethod)) {
 %>
											<i class="fab fa-paypal"></i> PayPal <%
											} else {
											%> <i
											class="bi bi-cash"></i> Cash on Delivery <%
 }
 %>
										</td>
									</tr>
						...
						<div class="table-responsive">
							<table class="table table-hover">
								...
								<tfoot>
									<tr class="table-active">
										<td colspan="3" class="text-end"><strong>Items
												Total:</strong></td>
						...
						<div class="d-flex justify-content-between mt-4">
							<a href="products.jsp" class="btn btn-outline-primary"> <i
								class="bi bi-arrow-left"></i> Continue Shopping
							</a> <a href="order-history.jsp" class="btn btn-primary"> <i
								class="bi bi-list-check"></i> View All Orders
							</a>
						...
						<div class="row mt-3">
							<div class="col-md-4 text-center">
								<div class="p-3 border rounded">
									...
									<p class="small text-muted">You'll receive an email
							...
							<div class="col-md-4 text-center">
								<div class="p-3 border rounded">
									...
									<p class="small text-muted">Track your order in "My Orders"
										section</p>
								</div>
							</div>
							<div class="col-md-4 text-center">
								<div class="p-3 border rounded">
									...
									<p class="small text-muted">Your order will arrive within
										3-5 business days</p>
								</div>
							</div>
						</div>
		...
		<div class="alert alert-info mt-4">
			<div class="d-flex align-items-center">
				...
				<div>
					...
					<p class="mb-0">We've sent an order confirmation to your email
						address. Please check your inbox (and spam folder).</p>
				</div>
			</div>
		</div>
	</div>
