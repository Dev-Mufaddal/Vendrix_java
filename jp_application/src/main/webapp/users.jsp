			...
			<div class="col-md-3 col-lg-2 p-0">
				<div class="sidebar">
					...
					<a href="dashboard.jsp"><i class="bi bi-speedometer2"></i>
						...
						Products</a> <a href="users.jsp" style="background: #495057;"><i
						class="bi bi-people"></i> Users</a> <a href="orders.jsp"><i
						class="bi bi-cart"></i> Orders</a> <a href="logout.jsp"><i
			...
			<div class="col-md-9 col-lg-10 p-4">
				<nav class="navbar navbar-light bg-light mb-4">
					<div class="container-fluid">
						...
						<span class="navbar-text"> Welcome, <%=userSession.getAttribute("user_fname")%>
						</span>
					</div>
				</nav>
 ...
 %>
									...
									<td>
										<button class="btn btn-sm btn-warning"
											onclick="makeAdmin(<%=rs.getInt("id")%>)">
